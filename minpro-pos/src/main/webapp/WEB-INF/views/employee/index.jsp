	...
	<div class="box box-info">
		...
		<div class="box-body">
			<div class="row">
				...
				<div class="col-md-3">
					<input type="email" class="form-control" name="em[email]" id="email"
						placeholder="Email" />
				</div>
			...
			<div class="row" id="row-role" style="display:none;">
				...
				<div class="col-md-3">
					<input type="password" name="ur[password]" id="password"
...
$('#list-staff').on('click','.btn-edit',
	...
	$.ajax({
		// url ke api/category/
		url:'${contextName}/api/employee/edit',
		type:'put',
		// data type berupa JSON
		dataType:'json',
		// mengirim parameter data
	...
	function deleteData($form){
		...
		$.ajax({
			// url ke api/category/
			url:'${contextName}/api/employee/delete',
