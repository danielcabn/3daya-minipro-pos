...
<div class="form-group">
			<div class="col-md-12">
				<input type="hidden" class="form-control" name="prNo" id="prNo" value="${KodeBaru }" />
			</div>
		</div>
	...
	<div class="col-md-12" style="border-top: 0px">
		...
		<div class="form-group">
			<div class="col-md-12">
				<input type="date" class="form-control" name="ready_item" id="ready_item" placeholder="tanggal" />
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-md-12">
				<textarea rows="7" cols="65" name="notes"></textarea>
			</div>
		</div>
<div class="form-group">
...
<div class="box-body no-padding">
	<table class="table table-stripped table-bordered">
		...
		<div class="form-group">
			<div class="col-md-12">
				<button type="button" class="btn btn-primary col-md-12" id="addItem">Add Item</button>
			</div>
		</div>
		</div>
