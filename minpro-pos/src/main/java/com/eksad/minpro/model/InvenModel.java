...
@GeneratedValue(strategy = GenerationType.TABLE, generator = "pos_mst_item_inventory")
@TableGenerator(name = "pos_mst_item_inventory", table = "tbl_squence", 
...
public void setBegining(Integer beginning) {
